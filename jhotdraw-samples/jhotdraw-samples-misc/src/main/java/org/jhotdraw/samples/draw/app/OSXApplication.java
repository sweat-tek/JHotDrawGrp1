...
import org.jhotdraw.samples.draw.app.action.app.AboutAction;
import org.jhotdraw.samples.draw.app.action.app.AbstractPreferencesAction;
import org.jhotdraw.samples.draw.app.action.app.ExitAction;
import org.jhotdraw.samples.draw.app.action.app.OpenApplicationAction;
import org.jhotdraw.samples.draw.app.action.app.OpenApplicationFileAction;
import org.jhotdraw.samples.draw.app.action.app.PrintApplicationFileAction;
import org.jhotdraw.samples.draw.app.action.app.ReOpenApplicationAction;
import org.jhotdraw.samples.draw.app.action.file.*;
import org.jhotdraw.samples.draw.app.action.file.CloseFileAction;
import org.jhotdraw.samples.draw.app.action.file.LoadDirectoryAction;
import org.jhotdraw.samples.draw.app.action.file.NewFileAction;
import org.jhotdraw.samples.draw.app.action.file.NewWindowAction;
import org.jhotdraw.samples.draw.app.action.file.OpenDirectoryAction;
import org.jhotdraw.samples.draw.app.action.file.PrintFileAction;
import org.jhotdraw.samples.draw.app.action.window.TogglePaletteAction;
import org.jhotdraw.samples.draw.app.osx.OSXAdapter;
import org.jhotdraw.samples.draw.app.osx.OSXPaletteHandler;
 ...
 *  Load Recent &gt; "Filename" ({@link LoadRecentFileAction#ID})
 *  Open Recent &gt; "Filename" ({@link OpenRecentFileAction#ID})
 *  -
